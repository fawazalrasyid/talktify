...
class RecommendationRoomCard extends StatelessWidget {
  final Room roomData;
  final bool isFirst;
  final bool isLast;

  const RecommendationRoomCard({
    super.key,
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          Helpers().capitalizeFirstLetter(roomData.type),
                          style: const TextStyle(
                      ...
                      const SizedBox(width: 8),
                      Text(
                        Helpers().formatDateTime(roomData.date),
                        style: const TextStyle(
